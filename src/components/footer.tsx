    ...
    <footer className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-700">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          {/* Product Links */}
          <div>
            <h3 className="font-display text-lg font-semibold mb-4 text-purple-700">Product</h3>
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <Link 
                    href={link.href}
                    className="text-gray-600 dark:text-gray-300 hover:text-purple-600 transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-display text-lg font-semibold mb-4 text-purple-700">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Resources Links */}
          <div>
            <h3 className="font-display text-lg font-semibold mb-4 text-purple-700">Resources</h3>
            <ul className="space-y-3">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-display text-lg font-semibold mb-4 text-purple-700">Legal</h3>
            <ul className="space-y-3">
